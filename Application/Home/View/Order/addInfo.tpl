      ...
      <div style="float:none">
            <div style="float:left">
              <label>
                 ...
                 <input class="form-control" name="province" id="province" style="width:100%">
              </label>
           </div>
           <div style="float:left;">
              <label>
                 市：<span style="color: #FF0000;">*</span>
                 <input class="form-control" name="city" id="city" style="width:100%">
           ...
           <div style="float:left;margin-top:0px;">
              <label>
                 ...
                 <input class="form-control" name="area" id="area" style="width:100%">
           ...
           <div style="float:left;">
              <label>
                 ...
                 <input class="form-control" name="detailed" id="detailed" style="width:150%">
           ...
           <div style="float:left;">
              <label>
                 ...
                 <input class="form-control" name="phone" type='number' id="phone" style="width:100%">

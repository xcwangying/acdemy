    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1 style="margin-bottom:10px">
                卖手成交详情&nbsp;->&nbsp;&nbsp;卖手：{$vip_info['vname']}&nbsp;->&nbsp;&nbsp;{$vip_info['vphone']}
            </h1>
            <ol class="breadcrumb">
                <li>后台管理</li>
                <li>数据分析</li>
                <li>卖手成交报表 </li>
                <li class="active">卖手成交详情</li>
            </ol>
        </section>
        <section>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="dataTables_length">
                                    <label>
                                        <a href="{:U('Data/bearStateMent')}"><input type="button" class="btn btn-sm btn-primary" value="返回"></a>
                                    </label>
                                </div>
                            </div> 
            ...
            <tbody>
                <volist name="orderList" id="vo">
                    <tr>
                        ...
                        <td class="text-center">{$vo.kphone}</td>
                        <td class="text-center">{$vo.money}</td>
                        <td class="text-center">{$vo['ktime']|date="Y-m-d H:i:s",###}</td>
                    </tr>
                </volist>
            </tbody>
        </table>

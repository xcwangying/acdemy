            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary" id="window_main">
                        <form role="form" method="post" action="{:U('Article/doAddActivity')}" name="frm" enctype="multipart/form-data" class="form-horizontal form-seperated shequn validform  window_main" cleandata="#pro_tbody">
                            <div class="box-body">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="datetimepicker3 input_date type input-sm input_ser" readonly name="activity_time" value="{$activity_time | date='Y-m-d ',###}"  style="height:30px;border:1px solid #d2d6de;border-radius: 0px;font-size:14px;" datatype="*"/>
                                </div>

                                <div>
                                    <label>报名截止时间：<span style="color: #FF0000;">*</span></label>
                                    <input type="text" class="datetimepicker3 input_date type input-sm input_ser" readonly name="over_time" value="{$over_time | date='Y-m-d ',###}"  style="height:30px;border:1px solid #d2d6de;border-radius: 0px;font-size:14px;" datatype="*"/>
                                </div>

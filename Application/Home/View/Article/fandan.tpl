                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="dataTables_length">
                                        <label>
                                            <a href="{:U('Article/addfandan')}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;添加商品</a>
                                            <php>if(isset($_GET['searchtext']) && !empty($_GET['searchtext'])){</php>
                                             <a href="{:U('Article/fandan')}"><input type="button" class="btn btn-sm btn-primary" value="撤销搜索"></a> 
                                            <php>}</php>
                                        </label>
                                    </div>
                                </div> 
                                            ...
                                            <if condition="$datalist">
                                                <volist name="datalist" id="item">
                                                   <switch name="item.goods_state">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{:U('Article/editfandan')}?goods_id={$item.goods_id}" class="btn btn-xs btn-warning">编辑</a>                                                      

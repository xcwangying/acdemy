                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_length">
                                    <label>
                                        <a href="{:U('Article/addActivity')}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;添加活动</a>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody class="text-center">
                                            <if condition="$data">
                                                <volist name="data" id="item">
                                                    <tr>
                                                        ...
                                                        <!--<th class="text-center"><a href="#" onclick="change('{$item.id}')"><if condition="$item['goods_name']">{$item['goods_name']}<else/>无</if></a></th>-->

                                                        <!-- <if condition="$item['synchronous'] eq 1">
                                                           <th class="text-center">是</th>
                                                         <else/>
                                                            <th class="text-center">否</th>
                                                         </if> -->
                                                        <th class="text-center">{$item.add_time|date='Y-m-d H:i:s',###}</th>
                                                        <th class="text-center">{$item.activity_time|date='Y-m-d',###}</th>
                                                        <th class="text-center">{$item.over_time|date='Y-m-d',###}</th>
                                                        ...
                                                        <th class="text-center">
                                                            ...
                                                            <a href="{:U('Article/editActivity')}?id={$item.id}" class="btn btn-xs btn-warning">编辑</a>
                                                            <if condition="$item['status'] eq 1">
                                            ...
                                            <else />
                                                <tr></tr>
                                                <tr>
                                                    <td class="into" colspan="9" style="vertical-align:middle;font-size:30px;" height="200">暂无信息</td>
                                                </tr>
                                            </if>
                                        </tbody>
                                    </table>

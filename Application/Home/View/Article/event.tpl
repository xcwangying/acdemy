                ...
                <tbody>
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td class="text-center"><if condition="$vo.vname neq NULL"><a href='javascript:void(0)' onclick='subgo("{$vo['vid']}")'>{$vo.vname}<a/><else/>--</if></td>
                            <td class="text-center">{$vo['time']|curtime=###}</td>

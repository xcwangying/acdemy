                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="dataTables_length">
                                        <label>
                                            <a href="{:U('Article/addinstrument')}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;添加仪器</a>
                                            <php>if(isset($_GET['searchtext']) && !empty($_GET['searchtext'])){</php>
                                             <a href="{:U('Article/instrument')}"><input type="button" class="btn btn-sm btn-primary" value="撤销搜索"></a> 
                                            <php>}</php>
                                        </label>
                                    </div>
                                </div> 
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">仪器价格</th>
                                                <th class="text-center">仪器主图</th>
                                        ...
                                        <tbody class="text-center">
                                            <if condition="$datalist">
                                                <volist name="datalist" id="item">
                                                   <switch name="item.goods_state">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{:U('Article/editinstrument')}?goods_id={$item.goods_id}" class="btn btn-xs btn-warning">编辑</a>                                                      
                                            ...
                                            <else />
                                                <tr></tr>
                                                <tr>
                                                    <td class="into" colspan="10" style="vertical-align:middle;font-size:30px;" height="200">暂无信息</td>
                                                </tr>
                                            </if>
                                        </tbody>
                                    </table>

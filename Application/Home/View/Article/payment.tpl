                                ...
                                <form class="searchform" method="get">
                                    <div class="col-sm-5">
                                        <div class="dataTables_length">
                                            <label>
                                            <a href="{:U('Article/courseList')}" class="btn btn-sm btn-primary">返回</a>
                                            <php>if($_GET['searchtext']!='' || $_GET['payStatus']!=''){</php>
                                            	<a href="{:U('Article/payment')}?goods_id={$_GET['goods_id']}"><input type="button" class="btn btn-sm btn-primary" value="撤销搜索"></a>
                                            <php>}</php>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody class="text-center">
                                ...
                                <volist name="data" id="item">
                                    <tr>
                                        ...
                                        <switch name="item.order_state">
                                            <case value="10"><td style="color:red"><b>待付款</b></td></case>
                                            <default /><td style="color:green"><b>已付款</b></td>
                                        ...
                                        <!-- <td style="text-align:left;">
                                            ...
                                            <if condition="$item['goods_ecommend'] gt 5">
                                                <switch name="item.order_state">
                            ...
                            <else />
                                <tr></tr>
                                <tr>
                                    <td class="into" colspan="11" style="vertical-align:middle;font-size:30px;" height="200">暂无信息</td>
                                </tr>
                            </if>
                        </tbody>
                    </table>

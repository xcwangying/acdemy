...
<block name="content">
    <!-- add by liu 图片裁剪 -->
<!-- 获取图片配置信息 -->
<?php $pic_info=C('picinfo')['classic'];?>
<style>
    .image {
        background: #666;
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-primary">
                        <form role="form" name="frm" action="{:U('Article/doMerStories')}" method="post" enctype="multipart/form-data" class="form-horizontal form-seperated shequn validform  window_main">
                            <div class="box-body">
                                <label>专访轮播图一<span style="color:red;font-size:12px;">(尺寸大小：750*640)</span></label>
                                ...
                                <label>专访轮播图二<span style="color:red;font-size:12px;">(尺寸大小：750*640)</span></label>
                                <!-- 待裁剪图片的div -->
                                ...
                                <label>专访轮播图三<span style="color:red;font-size:12px;">(尺寸大小：750*640)</span></label>
                                <!-- 待裁剪图片的div -->
        ...
        $.ajax({
            ...
            success:function(re){
                if(re.status == 1){
                    ...
                    window.setTimeout("window.location='"+"{:U('Article/merStories')}'",1500);
                }else{
                    art.dialog({
                      content:re.info,
                      lock:true

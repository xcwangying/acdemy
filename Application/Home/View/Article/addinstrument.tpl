            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary" id="window_main">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{:U('Article/doaddinstrument')}" name="frm" enctype="multipart/form-data" class="form-horizontal form-seperated shequn validform  window_main" cleandata="#pro_tbody">
                            <div class="box-body">
                                <div >
                                    <label>仪器名称：<span style="color: #FF0000;">*</span></label>
                                    <input type="text" class="form-control" datatype="*"  placeholder="(必填)请填写仪器名称！" name="goods_name">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control goods_price" datatype="currency" nullmsg="请填写仪器价钱" placeholder="(必填)请填写商品价格！" errormsg="请正确填写金额且需小于100万！" name="goods_price">
                                </div>

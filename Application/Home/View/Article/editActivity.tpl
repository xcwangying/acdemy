            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <form role="form" name="frm" action="{:U('Article/doEditActivity')}?id={$data.id}" method="post" enctype="multipart/form-data" class="form-horizontal form-seperated shequn validform  window_main">
                            <div class="box-body">
                                <div>
                                    <label>标题</label>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="datetimepicker3 input_date type input-sm input_ser" readonly name="activity_time" value="{$data.activity_time|date='Y-m-d',###}"  style="height:30px;border:1px solid #d2d6de;border-radius: 0px;font-size:14px;" datatype="*"/>
                                </div>

                                <div>
                                    <label>报名截止时间：<span style="color: #FF0000;">*</span></label>
                                    <input type="text" class="datetimepicker3 input_date type input-sm input_ser" readonly name="over_time" value="{$data.over_time|date='Y-m-d',###}"  style="height:30px;border:1px solid #d2d6de;border-radius: 0px;font-size:14px;" datatype="*"/>
                                </div>
                                ...
                                <div style="height:<?php echo $pic_info['h']*0.3?>px;">
                                    ...
                                    <div id="goods_image_view" class="view" <if condition="$data.picture  neq ''">style='background-image: url("/{$data.picture}");background-size:100% 100%;'<else/>style='margin-right:45px'</if>>
                                ...
                                <!-- <div>
                                    <label>推荐图片 &nbsp;&nbsp;&nbsp;<span style="color:#B34D4D">图片大小600*300px</span></label>
                ...
                $.ajax({
                    ...
                    success:function(re){
                        ...
                        if(re.status == 1){
                            ...
                            window.setTimeout("window.location='"+"{:U('Article/activity')}'",1500);
                        }else{
                            art.dialog({
                              content:re.info,
                              lock:true

            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary" id="window_main">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{:U('Article/doeditfandan')}" name="frm" enctype="multipart/form-data" class="form-horizontal form-seperated shequn validform  window_main" cleandata="#pro_tbody">
                            <div class="box-body">
                                <div >
                                    <label>商品名称：<span style="color: #FF0000;">*</span></label>
                                    <input type="text" class="form-control" datatype="*"  placeholder="(必填)请填写商品名称！" name="goods_name" value="{$goods_info.goods_name}">
                                    <input type="hidden" name="goods_id" value="{$goods_info.goods_id}">
                                </div>

                                <div >
                                    <label>商品价格：<span style="color: #FF0000;">*</span></label>
                                    <input type="text"class="form-control goods_price" datatype="currency" nullmsg="请填写商品售价" placeholder="(必填)请填写商品价格！" errormsg="请正确填写金额且需小于10万！" name="goods_price" value="{$goods_info.goods_price}">
                                </div> 
                                ...
                                <label>商品主图：<span style="color: #FF0000;">* （图片尺寸640*300）</span></label>
                                <!-- 待裁剪图片的div -->
                            ...
                            <div class="box-footer">
                                ...
                                <a href="{:U('Article/fandan')}" class="btn btn-info">返回</a>
                            </div>
                            </div>
                        </form>
                    </div>
        ...
        $.ajax({
            ...
            success:function(re){
                ...
                if(re.status == 1){
                    ...
                    window.setTimeout("window.location='"+"{:U('Article/fandan')}'",1500);
                }else{
                    art.dialog({
                      content:re.info,
                      lock:true
                    ...
                    //window.setTimeout(window.location="{:U('Article/fandan')}",2000);
                }
            }
        })      
        return false;

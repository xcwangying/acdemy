...
<div class="form-group">
    ...
    <button id="btnsss">提交</button>

    <div id="tel">15623060280</div>
</div>

<script type="text/javascript">
    webTitle = '标题';
     // var tt ="{$arr}";
   // $('#btnsss').html(webUploaderImgHtml(tt)) ;
    //商品展示图
    webUploaderImgs('#banner_img_filePicker',"http://admin.dym666.com/index.php/Index/douplodfiles", $('#banner_img'), $('input[name=banner_img]'), 1, "./webuploader-0.1.5/Uploader.swf");
    //商品展示图
    webUploaderImgs('#turn_img_filePicker', "http://admin.dym666.com/index.php/Index/douplodfiles",$('#turn_img'), $('input[name=turn_img]'), 3, "./webuploader-0.1.5/Uploader.swf", 4 ,true);

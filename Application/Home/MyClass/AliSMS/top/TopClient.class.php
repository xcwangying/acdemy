<?php
namespace User\MyClass\AliSMS\top;
use Think\Exception;
class TopClient
{
	public $appkey = '23351209';

	public $secretKey = 'bf90523a1f67ed0fae38b3d9bf183cab';
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
	{
		...
		$logger->conf["log_file"] = dirname(dirname(__FILE__)) . '/logs/top_comm_err_' . $this->appkey . '_' . date('Y-m-d') . '.log';
	...
	public function execute($request, $session = null,$bestUrl = null)
	{
		...
		{
			$logger = new TopLogger;
			$logger->conf["log_file"] = dirname(dirname(__FILE__)) . '/logs/top_biz_err_' . $this->appkey . '_' . date('Y-m-d') . '.log';
			$logger->log(array(
				date("Y-m-d H:i:s"),
				$resp.PHP_EOL
			));
